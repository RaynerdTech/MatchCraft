...
export default function PayoutSettingsForm() {
  ...
  useEffect(() => {
    if (user) {
      ...
      setIsOrganizerOrAdmin(['organizer', 'admin'].includes(userRole));
    }
  }, [user]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        "Subaccount created successfully! 🎉 You'll now receive payouts automatically."
      );
      router.refresh();
    } catch (err: any) {
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-8 text-center">
            ...
            <p className="text-blue-100 max-w-md mx-auto">
              {isOrganizerOrAdmin
                ...
                : "Payout settings are only available for organizers"}
            </p>
          </div>
            ...
            {!user ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  {formData.accountNumber.length > 0 &&
                    formData.accountNumber.length < 10 && (
                      ...
                      >
                        <FiAlertCircle className="mr-1" /> Account number must
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-green-600 mt-2">
                          Payments will now be automatically routed to your bank
                          account.
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex items-start text-sm text-gray-500 pt-2">
                  ...
                  <p>
                    Your bank details are encrypted and securely stored. We
                    never store your full account information.
                  </p>
                </div>
              </form>
            ) : (
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-2 text-sm text-yellow-700">
                      Payout settings are only available for event organizers
                      and administrators. If you believe this is an error,
