  ...
  return (
    <div className="max-w-md mx-auto px-4 py-8 space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-purple-800 mb-2">Verify Event Ticket</h1>
        <p className="text-gray-600">Scan QR code or enter details manually</p>
      </div>

      {/* QR SCANNER */}
      <div className="bg-white p-6 rounded-xl shadow-md space-y-4 border border-gray-100">
        <div className="flex justify-between items-center">
          <h2 className="font-semibold text-lg text-gray-800">QR Code Scanner</h2>
          <button
        ...
        {scanning && (
          <div className="border-2 border-dashed border-gray-200 rounded-lg p-4">
            ...
            <p className="text-sm text-center text-gray-500 mt-2">Point camera at QR code to scan</p>
          </div>
        )}
      </div>
      ...
      {/* MANUAL INPUT */}
      <div className="bg-white p-6 rounded-xl shadow-md space-y-4 border border-gray-100">
        <h2 className="font-semibold text-lg text-gray-800">Manual Verification</h2>
        <div className="space-y-3">
          <div>
            <label htmlFor="eventId" className="block text-sm font-medium text-gray-700 mb-1">Event ID</label>
            <input
              id="eventId"
              type="text"
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-all flex items-center justify-center"
        >
          {isLoading ? (
            <span className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <p className="text-gray-800 font-mono">{result.reference}</p>
              </div>
            </div>
          </div>
