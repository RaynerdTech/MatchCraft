// app/dashboard/failedpayment/[eventId]/ClientEventPage.tsx
'use client';
...
export default function ClientEventPage({ eventId }: { eventId: string }) {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-10 space-y-8">
      {showFailed ? (
        ...
        <div>
          <h1 className="text-2xl font-bold">Event Info for {eventId}</h1>
        </div>
      )}
    </div>
  );
