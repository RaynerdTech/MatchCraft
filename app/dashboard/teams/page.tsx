  ...
  if (!team) return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="text-center p-6 max-w-md">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">No Team Found</h1>
        <p className="text-gray-600">We couldn't find any team associated with your account.</p>
      </div>
    </div>
  )
      ...
      <main className="max-w-6xl mx-auto bg-white rounded-xl shadow-md overflow-hidden md:mx-4">
        ...
        <div className="p-4 md:p-6 space-y-8">
          ...
          <section aria-labelledby="event-info-heading">
            <h2 id="event-info-heading" className="text-xl font-semibold text-gray-800 mb-4">Event Information</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <p className="text-gray-900">{format(new Date(team.event.date), 'PPPP')}</p>
                </div>
                <div>
          ...
          <section aria-labelledby="creator-heading">
            <h2 id="creator-heading" className="text-xl font-semibold text-gray-800 mb-4">Event Creator</h2>
            <div className="flex items-center space-x-4 bg-gray-50 p-4 rounded-lg">
              ...
              <div className="min-w-0">
                <p className="font-semibold text-gray-900 truncate">{team.event.createdBy.name}</p>
                <p className="text-gray-600 truncate" title={team.event.createdBy.email}>
          ...
          <section aria-labelledby="members-heading">
            <div className="flex justify-between items-center mb-4">
              <h2 id="members-heading" className="text-xl font-semibold text-gray-800">Team Members</h2>
                ...
                >
                  <div className="flex gap-4 items-center">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-600 truncate" title={member.userId.email}>
                        {member.userId.email}
                      </p>
                      <div className="flex space-x-3 mt-1">
                        <span className={`text-xs font-medium ${member.accepted ? 'text-green-600' : 'text-red-600'}`}>
                          {member.accepted ? 'Accepted' : 'Pending'}
                        </span>
                        <span className={`text-xs font-medium ${member.paid ? 'text-green-600' : 'text-red-600'}`}>
