  ...
  return (
    <footer className="bg-gray-100 border-t mt-20 py-10 px-6 md:px-12 text-gray-700">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
        {/* Left - Logo & Tagline */}
        <div>
          <h2 className="text-xl font-bold text-blue-600">SoccerZone</h2>
          <p className="text-sm mt-2">Built by football lovers, for football lovers. ⚽</p>
        </div>
        ...
        <div className="text-sm text-gray-500">
          &copy; {new Date().getFullYear()} SoccerZone. All rights reserved.
        </div>
      </div>
    </footer>
  );
